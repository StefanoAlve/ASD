...
int main() {
    ...
    printf("\nEcco gli diagonali presenti nel file:\n");
...
void algGreedy(diagonale* diagonali, int num_diag, int DP)
{
    ...
    // mancano da controllare solo le condizioni di:
    // 1) un elemento acrobatico e uno indietro nel corso del programma (non necessariamente nella stessa diagonale
    // 2) almeno una diagonale in cui compaiono almeno due elementi acrobatici in sequenza
