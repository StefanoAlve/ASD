...
int vertexCover(arco *archi, dimensioni dimensione, int *sol, int index, int count);
...
int main() {
    ...
    //Funzione ricorsiva che cerca i vertex cover
    int numSol = vertexCover(archi, dimensione, sol, 0, 0);
